  ...
  factory: (require) => {
    ...
    function renderChips() {
      ...
      fileQueue.forEach(function (item) {
        ...
        chip.style.cssText = 'display:inline-flex;align-items:center;gap:6px;max-width:200px;height:34px;' +
          'border:1.5px solid ' + kind.color + ';background:rgba(92,108,213,.09);' +
          'color:var(--dsw-alias-fg-primary,#26231f);border-radius:6px;padding:0 8px;' +
          'font:12px/1.4 sans-serif;box-sizing:border-box'
        var label = document.createElement('span')
        label.textContent = kind.icon + ' ' + item.name
