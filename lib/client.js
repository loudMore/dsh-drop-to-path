    ...
    function renderChips() {
      ...
      fileQueue.forEach(function (item) {
        ...
        chip.style.cssText = 'position:relative;display:inline-flex;flex-direction:column;align-items:center;' +
          'justify-content:center;gap:2px;width:62px;height:62px;box-sizing:border-box;' +
        ...
        iconBox.style.cssText = 'font-size:26px;line-height:1'
        var label = document.createElement('span')
        label.textContent = item.name
        label.title = item.name
        label.style.cssText = 'max-width:56px;overflow:hidden;text-overflow:ellipsis;white-space:nowrap;' +
