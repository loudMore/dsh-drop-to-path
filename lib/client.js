    ...
    function installFileInterception() {
      var onDrop = function (event) {
        ...
        others.forEach(function (file) {
          chain = chain.then(function () { return upload(file) }).then(insertPath).catch(function (error) {
        ...
        // UI for images dragged together with other files. If re-dispatch
        // fails for any reason, upload the images as paths instead so they
            ...
            setTimeout(function () {
              try {
                ...
                images.forEach(function (f) {
                  chain = chain.then(function () { return upload(f) }).then(insertPath).catch(function (err) {
